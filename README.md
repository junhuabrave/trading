...
simulator trades around is the one the book holds. Not a trading system yet: no router, and no
venue or client gateways; the harness still uses explicit stand-ins for those. Two things
